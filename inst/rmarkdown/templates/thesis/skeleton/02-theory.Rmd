...
output:
  iheiddown::chapter_pdf:
    input: "02-theory.Rmd" # Replace with whatever the name of this file is
    author: "Author"
    chapter: "2"
    in_context: false
---

\setcounter{chapter}{1} <!-- Set the counter at one number less than the chapter number to initialize it. -->
# Theory {#theory}
