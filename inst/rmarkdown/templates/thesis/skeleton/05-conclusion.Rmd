...
output:
  iheiddown::chapter_pdf:
    input: "05-conclusion.Rmd" # Replace with whatever the name of this file is
    author: "Author"
    chapter: "5"
    in_context: false
---

\setcounter{chapter}{4} <!-- Set the counter at one number less than the chapter number to initialize it. -->
