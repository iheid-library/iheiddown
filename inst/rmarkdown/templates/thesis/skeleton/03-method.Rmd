...
output:
  iheiddown::chapter_pdf:
    input: "03-method.Rmd" # Replace with whatever the name of this file is
    author: "Author"
    chapter: "3"
    in_context: false
---

\setcounter{chapter}{2} <!-- Set the counter at one number less than the chapter number to initialize it. -->
# Methods {#methods}
