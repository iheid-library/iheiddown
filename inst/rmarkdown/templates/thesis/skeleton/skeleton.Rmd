...
# csl: bibstyles/chicago-author-date.csl #Uncomment to integrate the bibliography style file that you have put in the bibstyles folder of your thesis. Search the Zotero Stlye Repository for the required citation style (https://www.zotero.org/styles).
nocite: '@*' #Uncomment if you want all elements in your .bib file to appear in your bibliography (i.e. all R-packages you used)

#####################
## PDF Formatting  ##
#####################
draft: true # add DRAFT mark in the footer?
...
#####################
output:
  iheiddown::thesis_pdf:
    input: "00-Untitled.Rmd" # Replace with whatever the name of this file is, e.g. "mythesis.Rmd"
    author: *author
link-citations: true
documentclass: book
---
...
<!-- This chunk creates automatically a .bib file to cite the loaded packages in the bibliography. Do not forget to uncomment "nocite: '@*'" in the header if you want all packages to be cited even if you did not mention them in the body of the text.-->
...
(and the power of **R**)
should make *useful for everyone writing theses or dissertations at the Graduate Institute*.
