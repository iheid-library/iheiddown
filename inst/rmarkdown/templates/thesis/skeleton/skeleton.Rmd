...
secondreader: Aragorn II Elessar
examiner: Gimli # only required if PhD; otherwise delete or comment out
...
output:
  iheiddown::thesis_pdf:
    input: "Untitled.Rmd" # Replace with whatever the name of this file is, e.g. "mythesis.Rmd"
    author: *author
link-citations: true
documentclass: book
---
