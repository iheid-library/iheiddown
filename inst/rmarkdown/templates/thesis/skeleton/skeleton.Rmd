...
# csl: apa.csl #Uncomment to integrate the bibliography style file that you have put in the root folder of your thesis. Search the Zotero Stlye Repository for the required citation style (https://www.zotero.org/styles).
# nocite: '@*' #Uncomment if you want all elements in your .bib file to appear in your bibliography.
