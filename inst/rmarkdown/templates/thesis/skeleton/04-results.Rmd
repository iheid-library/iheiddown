...
output:
  iheiddown::chapter_pdf:
    input: "04-results.Rmd" # Replace with whatever the name of this file is
    author: "Author"
    chapter: "4"
    in_context: false
---

\setcounter{chapter}{3} <!-- Set the counter at one number less than the chapter number to initialize it. -->
# Results {#results}
