...
output:
  iheiddown::chapter_pdf:
    input: "01-introduction.Rmd" # Replace with whatever the name of this file is
    author: "Author"
    chapter: "1"
    in_context: false
---

 \setcounter{chapter}{0} <!-- Set the counter at one number less than the chapter number to initialize it. -->
# Introduction {#intro}
