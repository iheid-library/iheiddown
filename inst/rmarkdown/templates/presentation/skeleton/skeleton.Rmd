...
# Showcasing useful packages
install.packages(icons) # Adds icons package
icons::download_fontawesome() # Need to download icons before using them
```
...
## Add a nice looking logo to your presentation 
...
---
class: inverse iheid-red center middle
...
.pull-right[
[`r icons::icon_style(fontawesome("github"), scale = 2, fill = "white")`](https://github.com/jhollway/iheiddown)
]
...
.pull-right[
[`r icons::icon_style(icons::fontawesome("github"), scale = 2, fill = "white")`](https://github.com/jhollway/iheiddown)

[`r icons::icon_style(icons::fontawesome("link"), scale = 1.5, fill = "white")`](https://jameshollway.com/)
]
