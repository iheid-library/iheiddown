...
[![Codecov test coverage](https://codecov.io/gh/jhollway/iheiddown/branch/main/graph/badge.svg)](https://app.codecov.io/gh/jhollway/iheiddown?branch=main)
...
The package is built upon the [IHEID LaTeX dissertation template](https://github.com/iheid-library/iheidmytex),
...
by looking up the latest release of the package [here](https://github.com/iheid-library/iheiddown/releases/latest).
...
[package website](https://iheid-library.github.io/iheiddown/).

## Feedback

Please [raise an issue](https://github.com/iheid-library/iheiddown/issues) for this repo
