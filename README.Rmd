...
Institut de hautes ?tudes internationales et du d?veloppement (IHEID)
in (R) markdown.
...
With release 0.8.0 of the `{iheiddown}` package, you are now able to create beautiful IHEID-themed presentations to make your
work shine during your presentations. This feature is based on the great `{xaringan}` package available [here](https://github.com/yihui/xaringan).
...
```{r, echo=FALSE}
  suppressMessages(qData::plot_releases("jhollway/iheiddown"))
```
