...
![Step 1: open a new project](images/problemset/0-Open_Project.PNG){width="80%"}
...
"Problem Set {iheiddown}" template. Now give your presentation a name and click
on "OK".

![Step 2: select the template](images/problemset/1-Create_PS.PNG){width="80%"}
...
while viewing the `MySyllabus.Rmd` pane. Et voilà! You have now successfully
generated your first syllabus with R.
