...
pkgs <- c("iheiddown", "magrittr", "ggplot2", "leaflet", "knitr", "kableExtra",
          "DT")
...
Now, use the icons inline with `icons::fontawesome$brands$github`.
For example to link back to the `{iheiddown}` repo with a GitHub logo:
[`r icons::fontawesome$brands$github`](https://github.com/jhollway/iheiddown)
