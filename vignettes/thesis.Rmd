...
`remotes::install_github("jhollway/iheiddown")` in the R-Studio console.
  - The package will soon be made available on CRAN. This will enable you to
  install the package even faster by simply typing
  `install.packages("iheiddown")`. We will update the vignette when this is the
  case.
...
![Step 1: open a new project](images/thesis/0-Open_Project.PNG){width="80%"}
...
![Step 2: select the template](images/thesis/1-Create_Thesis.PNG){width="80%"}
